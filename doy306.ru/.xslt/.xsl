...
<!-- нв® зв®Ўл гЎа вм ўбҐ ­Ґ®Ўа Ў®в ­­лҐ вҐЈЁ Ё§ Ї®¤бЁвҐ¬л Ё¤Ґ­вЁдЁЄ жЁЁ -->
<xsl:template match='identify:abc' identify:dummy="" xsl:exclude-result-prefixes="identify">
</xsl:template>

<!-- нв® зв®Ўл гЎа вм ў®®ЎйҐ ўбҐ ­Ґ®Ўа Ў®в ­­лҐ вҐЈЁ -->
<xsl:template match="*">
</xsl:template>

<!-- нв® зв®Ўл ­Ґ®Ўа Ў®в ­­лҐ вҐЈЁ Є®Їа®ў «Ёбм жҐ«ЁЄ®¬,   ­Ґ в®«мЄ® вҐЄбв®¬ -->
<xsl:template match="*">
    <xsl:copy>
